...
-- CreateIndex
CREATE UNIQUE INDEX "token_usages_userId_month_year_key" ON "token_usages"("userId", "month", "year");

-- CreateIndex
CREATE UNIQUE INDEX "payments_transactionId_key" ON "payments"("transactionId");

-- AddForeignKey
ALTER TABLE "user_profile" ADD CONSTRAINT "user_profile_email_fkey" FOREIGN KEY ("email") REFERENCES "users"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
